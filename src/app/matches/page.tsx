...
export default async function MatchesPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f8f8fc] text-slate-900">
      ...
      <section className="mx-auto max-w-7xl px-5 py-10 sm:px-8 sm:py-14"><div className="max-w-3xl"><MatchesWorkspace initialProfile={initialProfile} projects={matchingProjects} userId={user.id} /></div></section>
    </main>
  );
}
